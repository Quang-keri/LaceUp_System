...
class AchievementShowcaseScreen extends StatefulWidget {
  const AchievementShowcaseScreen({super.key});

  @override
  State<AchievementShowcaseScreen> createState() =>
      _AchievementShowcaseScreenState();
}

class _AchievementShowcaseScreenState extends State<AchievementShowcaseScreen> {
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Tủ kính thành tựu'),
