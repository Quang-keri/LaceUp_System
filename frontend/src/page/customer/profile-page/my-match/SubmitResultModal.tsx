...
import { Trophy, UserX, CheckCircle2, AlertTriangle, Flag } from "lucide-react";
...
const SubmitResultModal: React.FC<SubmitResultModalProps> = ({
  ...
  const handleReport = () => {
    // Đóng Modal hiện tại và mở Modal Báo cáo
    onClose();
    ...
    <>
      ...
      >
        <div className="mt-5 space-y-5">
          <div className="bg-blue-50/60 border border-blue-200 text-blue-700 text-[12px] p-2.5 rounded-lg flex gap-2">
            <AlertTriangle
              size={16}
              className="shrink-0 mt-0.5 text-blue-500"
            />
            <span className="leading-relaxed font-medium">
              Chỉ dùng tính năng này khi <b>trận đấu đã diễn ra xong</b>. Nếu
              thiếu người từ đầu và muốn hủy trận để đặt lại phòng, hãy dùng nút{" "}
              <b>Báo cáo khẩn cấp</b> ở bên dưới.
            </span>
          </div>
          ...
          <div className="bg-rose-50/60 p-4 rounded-xl border border-rose-100/70">
            ...
            <div className="flex items-start gap-1.5 text-[11px] text-rose-600/90 mb-3 leading-relaxed">
              ...
              <span>
                Đánh dấu người không ra sân (nhưng trận đấu vẫn tiếp tục). Thành
                viên bị đánh dấu sẽ bị trừ uy tín khi chốt đơn.
              </span>
            </div>
          ...
          <div className="flex items-center justify-between pt-2">
            <Button
              type="text"
              danger
              className="flex items-center gap-1.5 font-semibold text-rose-500 hover:bg-rose-50 px-3 h-11 rounded-xl"
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                loading={loading}
                className="px-6 h-11 rounded-xl bg-gradient-to-r from-orange-500 to-purple-600 border-none hover:opacity-90 font-bold text-white shadow-sm"
              >
                Gửi kết quả
              </Button>
            </div>
