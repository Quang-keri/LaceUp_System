...
const generateAvatarSVG = (
  ...
  const color = userId
    ...
    : "#8b5cf6"; // Mặc định tông tím (violet-500) nếu không có userId
...
const ChatList = ({
  ...
  const transformedConversations: Chat[] = conversations
    .map((conv) => {
      ...
      const validConversationId = conv.conversationId || "";
      ...
      >
        <div className="relative mb-3">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2 border rounded-full focus:ring-2 focus:ring-purple-500 outline-none text-sm ${
              isDarkMode
                ...
                >
                  <div className="relative">
                    <img
                      src={chat.avatar}
                      alt=""
                      className={`w-12 h-12 rounded-full mr-3 ring-2 ${
                        isSelected ? "ring-purple-500" : "ring-transparent"
                      }`}
                    />
                  </div>
                  ...
                  {chat.isRead === false && (
                    <div className="w-2.5 h-2.5 bg-purple-500 rounded-full ml-2" />
                  )}
                </div>
              );
            })}
