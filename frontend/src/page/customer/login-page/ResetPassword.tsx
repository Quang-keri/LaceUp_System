  ...
  if (!token) {
    return (
      <div className="flex justify-center items-start pt-15 min-h-screen bg-[#F3F4F6] [font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif] pb-5">
        <Card
          className="w-full max-w-105 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] text-center p-2.5"
          bordered={false}
        >
          <Alert
        ...
        >
          ...
          <Form.Item style={{ marginBottom: 0 }}>
            <Button
              ...
              block
              loading={isLoading}
              className="!h-11 !rounded-lg !border-[#9156F1] !bg-[#9156F1] !font-semibold !text-white hover:!border-[#7E46D6] hover:!bg-[#7E46D6]"
            >
              Xác nhận
            </Button>
          </Form.Item>
