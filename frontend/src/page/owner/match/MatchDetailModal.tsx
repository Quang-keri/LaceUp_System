...
import { Modal, Descriptions, Table, Tag, Avatar, Typography, Divider, Space } from 'antd';
        ...
        >
            <Descriptions bordered column={2} size="middle" className="bg-gray-50">
                <Descriptions.Item label="Sân thi đấu" span={2}>
                    <Text strong className="text-blue-600">{match.courtName}</Text>
                </Descriptions.Item>
                <Descriptions.Item label="Môn thi đấu">
                    <Tag color="cyan" className="font-medium">{match.categoryName}</Tag>
                </Descriptions.Item>
                ...
                <Descriptions.Item label="Trạng thái">
                    <Tag color={
                        match.status === 'CONFIRMED' ? 'green' :
                            match.status === 'FULL' ? 'volcano' : 'blue'
                    }>
                        {match.status}
                    </Tag>
                </Descriptions.Item>
                <Descriptions.Item label="Chi phí">
                    <Text type="success" strong>
                        {match.price?.toLocaleString('vi-VN')} đ/người
                    </Text>
                </Descriptions.Item>
            ...
            <Divider orientation="left">
                <Space>
                    <Users size={18} />
                    <span>Danh sách đã đăng ký ({match.currentPlayers}/{match.maxPlayers})</span>
                </Space>
            </Divider>
