...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const items: MenuItem[] = [
    ...
    getItem("Quản lý người dùng", "sub_users", <UserOutlined />, [
      ...
      getItem(
        <Link to="/admin/permissions">Quyền hạn</Link>,
        "/admin/permissions",
      ),
      getItem(
        <Link to="/admin/customers">Khách hàng (Thành viên)</Link>,
        "/admin/customers",
      ),
    ]),
    ...
    getItem("Quản lý sân bãi", "sub_courts", <ShopOutlined />, [
      ...
      getItem(
        <Link to="/admin/amenities">Dịch vụ đi kèm (Nước, Áo pitch)</Link>,
        "/admin/amenities",
      ),
    ]),
    ...
    getItem(
      <Link to="/admin/reviews">Đánh giá & Phản hồi</Link>,
      "/admin/reviews",
      <StarOutlined />,
    ),
    ...
    getItem("Cài đặt hệ thống", "sub_settings", <SettingOutlined />, [
      ...
      getItem(
        <Link to="/admin/banners">Quản lý Banner/Quảng cáo</Link>,
        "/admin/banners",
      ),
    ]),
